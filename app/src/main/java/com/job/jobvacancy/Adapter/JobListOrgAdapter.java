...
import com.job.jobvacancy.ViewMyJobOrg;
...
public class JobListOrgAdapter extends RecyclerView.Adapter<JobListOrgAdapter.JobVancayHolder>implements Filterable {

    Context context;
    List<JobModel> jobDetailsModels;
    List<JobModel> jobDetailsModelsfilter;

    public JobListOrgAdapter(Context context, List<JobModel> jobDetailsModels) {
    ...
    public JobVancayHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new JobListOrgAdapter.JobVancayHolder(layout);
    }
    ...
    public void onBindViewHolder(@NonNull JobVancayHolder holder, final int position) {
        ...
        holder.tv_view_more.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(context, ViewMyJobOrg.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                intent.putExtra("job_id_view_job_org",jobDetailsModelsfilter.get(position).getJob_id());
